...
///
/// \author Ben Smith
/// $Date: 2020-02-07 14:13:25 +0000 (Fri, 07 Feb 2020) $
///
///////////////////////////////////////////////////////////////////////////////////////
...
std::vector<std::pair<double, double> > CRUInput::translate_gridlist_to_coord(ListArray_id<Coord>& gridlist) {
	...
	while (gridlist.isobj) {
		...
		double center_lon = c.lon;//floor(c.lon * (1/ soilinput.STEP)) * soilinput.STEP + soilinput.STEP / 2.0;
		double center_lat = c.lat;//floor(c.lat * (1 / soilinput.STEP)) * soilinput.STEP + soilinput.STEP / 2.0;
